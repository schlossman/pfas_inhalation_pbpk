...
plot.Kim <- function(out, out.inc = NULL, chem, sex, dose, img.name = NULL){
  ...
  if (chem == "PFHxS") {
    Pylim <- c(y_min,3.5e5)#y_max)#1.5e5
  } else if (chem == "PFNA") {
    Pylim <- c(y_min, 50)
  } else if (chem == "PFDA") {
    Pylim <- c(y_min, 25)
  ...
  plot(1,1, type = "n", log = "y", xlim = c(0,sim.days), 
  ...
  lines(out.inc$time.days, out.inc$C_bl*C.convert, 
        lty = inc.templ.lty, lwd = 3, col = inc.templ.col)
  points(Pdata[,1], Pdata[,2], col = paper.col, pch = 19)
  ...
  lines(out.inc$time.days, out.inc$C_li*C.convert,
        lty = inc.templ.lty, lwd = 3, col = inc.templ.col)
  points(Ldata[,1], Ldata[,2], col = paper.col, pch = 19)
  ...
  if (chem == "PFHxS") {
    Kylim <- c(y_min, 3.5e4)#y_max)1.5e4
  } else if (chem == "PFNA") {
    Kylim <- c(y_min, 0.75e1)#y_max)
  } else if (chem == "PFDA") {
    Kylim <- c(y_min, 20)
  } else {
    Kylim <- c(y_min, y_max)
  ...
  lines(out.inc$time.days, out.inc$C_ki*C.convert,
        lty = inc.templ.lty, lwd = 3, col = inc.templ.col)
  points(Kdata[,1], Kdata[,2], col = paper.col, pch = 19)
 ...
 if (chem == "PFNA" & sex == "female") {
    Uylim <- c(y_min,400)#y_max)
  } else {
    Uylim <- c(y_min, y_max)
  }
  
  plot(1,1, type = "n", xlab = "Time (day)", xlim = c(0,sim.days),
       ylab = paste("Cum. Amt. of", chem, "(ug)",sep = " "), ylim = Uylim)
  ...
  lines(out.inc$time.days, out.inc$A_urine*1000,
        lty = inc.templ.lty, lwd = 3, col = inc.templ.col)
  points(Udata[,1], Udata[,2], col = paper.col, pch = 19)
  ...
  legend("bottomleft", legend = c("Published Data", "Published Model"),
         ...
         col = c(paper.col, paper.col),
         lty = c(NA, paper.lty), 
         pch = c(19,NA), lwd = c(1,2))#, text.width = textwidths)
  legend("bottomright", legend = c("Template Version with Published Flow", "Template Version with Corrected Flow"),
         xpd = TRUE, inset = c(0.03, 0), bty = "n",
         col = c(inc.templ.col, cor.templ.col),
         lty = c(inc.templ.lty, cor.templ.lty),
         pch = c(NA,NA), lwd = c(3,3))#, text.width = textwidths)
...
plot.Kudo.Loccisano <- function(out, dose = NULL, img.name = NULL){
  ...
  if (dose == "low"){
    plasma.data <- read.csv(file = paste0(data.loc, "Data_Fig8_Kudo_lowPlasma.csv"), header = TRUE, sep = ",")
    liver.data <- read.csv(file = paste0(data.loc, "Data_Fig8_Kudo_lowLiver.csv"), header = TRUE, sep = ",")
  } else if (dose == "high"){
    plasma.data <- read.csv(file = paste0(data.loc, "Data_Fig8_Kudo_highPlasma.csv"), header = TRUE, sep = ",")
    liver.data <- read.csv(file = paste0(data.loc, "Data_Fig8_Kudo_highLiver.csv"), header = TRUE, sep = ",")
  }
  
  ylabel = "Conc. of PFOA (ug/mL)"
  xlabel = "Time (hours)"
  ...
  xmax <- max(out$time.hr)
  ymin <- min(out$C_bl)
  ymax <- max(out$C_bl)
  plot(1,1, type = "n", xlab = xlabel, xlim = c(0,xmax),
       ylab = ylabel, ylim = c(ymin,ymax))
  lines(out$time.hr, out$C_bl, lty = cor.templ.lty, col = cor.templ.col, lwd = 3)
  points(plasma.data[,1],plasma.data[,2], col = paper.col, pch = 19)
  lines(plasma.data[,3], plasma.data[,4], lty = paper.lty, col = paper.col, lwd = 2)
  title("Plasma", line = -1.25)
  
  y_min <- min(out$C_li[out$C_li > 0], liver.data[,2], liver.data[,4], na.rm = TRUE)
  y_max <- max(out$C_li, liver.data[,2], liver.data[,4], na.rm = TRUE)
  Lylim <- c(y_min,y_max)
  
  plot(1,1, type = "n", xlab = xlabel, xlim = c(0,xmax),
       ylab = ylabel, ylim = Lylim)
  lines(out$time.hr, out$C_li, lty = cor.templ.lty, col = cor.templ.col, lwd = 3)
  points(liver.data[1,1],liver.data[1,2], col = paper.col, pch = 19)
  lines(liver.data[,3], liver.data[,4], lty = paper.lty, col = paper.col, lwd = 2)
  title("Liver", line = -1.25)
...
plot.Kemper.Loccisano <- function(out, dose.type = NULL, dose = NULL, sex = NULL, img.name = NULL){
  ...
  if (dose.type == "iv"){
    if (sex == "male"){
      plasma.data <- read.csv(file = paste0(data.loc, "Data_Fig9_Kemper_IVdosePlasma.csv"), header = TRUE, sep = ",")
    } else if (sex == "female"){
      plasma.data <- read.csv(file = paste0(data.loc, "Data_Fig11_Kemper_IVdosePlasma.csv"), header = TRUE, sep = ",")
    }
  } else if (dose.type == "oral"){
    if (dose == 25){
      if (sex == "male"){
        plasma.data <- read.csv(file = paste0(data.loc, "Data_Fig9_Kemper_OraldosePlasma.csv"), header = TRUE, sep = ",")
        excretion.data <- read.csv(file = paste0(data.loc, "Data_Fig9_Kemper_OraldoseExcretion.csv"), header = TRUE, sep = ",")
      } else if (sex == "female"){
        plasma.data <- read.csv(file = paste0(data.loc, "Data_Fig11_Kemper_OraldosePlasma.csv"), header = TRUE, sep = ",")
        excretion.data <- read.csv(file = paste0(data.loc, "Data_Fig11_Kemper_OraldoseExcretion.csv"), header = TRUE, sep = ",")
      }
    } else if (dose == 5){
      if (sex == "male"){
        plasma.data <- read.csv(file = paste0(data.loc, "Data_Supp2_Kemper_Oraldose5Plasma.csv"), header = TRUE, sep = ",")
        excretion.data <- read.csv(file = paste0(data.loc, "Data_Supp2_Kemper_Oraldose5Excretion.csv"), header = TRUE, sep = ",")
      } else if (sex == "female"){
        plasma.data <- read.csv(file = paste0(data.loc, "Data_Supp4_Kemper_Oraldose5Plasma.csv"), header = TRUE, sep = ",")
        excretion.data <- read.csv(file = paste0(data.loc, "Data_Supp4_Kemper_Oraldose5Excretion.csv"), header = TRUE, sep = ",")
      }
    } else if (dose == 1){
      if (sex == "male"){
        plasma.data <- read.csv(file = paste0(data.loc, "Data_Supp2_Kemper_Oraldose1Plasma.csv"), header = TRUE, sep = ",")
        excretion.data <- read.csv(file = paste0(data.loc, "Data_Supp2_Kemper_Oraldose1Excretion.csv"), header = TRUE, sep = ",")
      } else if (sex == "female"){
        plasma.data <- read.csv(file = paste0(data.loc, "Data_Supp4_Kemper_Oraldose1Plasma.csv"), header = TRUE, sep = ",")
        excretion.data <- read.csv(file = paste0(data.loc, "Data_Supp4_Kemper_Oraldose1Excretion.csv"), header = TRUE, sep = ",")
      }
    }
  }
  ...
  xmax <- max(plasma.data[,1])
  y_min <- min(out$C_bl[out$C_bl > 0], plasma.data[,2], na.rm = TRUE)
  plasma.dataMax <- max(plasma.data[,2], plasma.data[,4], plasma.data[,6], plasma.data[,8])
  y_max <- max(out$C_bl, plasma.dataMax, na.rm = TRUE)
  Pylim <- c(y_min, 200)#y_max)
  
  plot(1,1, type = "n", xlab = xlabel, xlim = c(0,xmax),
       ylab = ylabel, ylim = Pylim, log = "y")
  points(plasma.data[,3],plasma.data[,4], pch = 19, col = paper.col)
  points(plasma.data[,5],plasma.data[,6], pch = 19, col = paper.col)
  points(plasma.data[,7],plasma.data[,8], pch = 19, col = paper.col)
  lines(plasma.data[,1], plasma.data[,2], lty = paper.lty, col = paper.col, lwd = 2)
  lines(out$time.hr, out$C_bl, lty = cor.templ.lty, col = cor.templ.col, lwd = 3)
  title("Plasma", line = -1.25)
  ...
  if (dose.type == "oral"){
    ...
    y_min <- min(excretion.data[,2], excretion.data[,6], na.rm = TRUE)
    y_max <- max(excretion.data[,2], excretion.data[,6], na.rm = TRUE)
    Eylim <- c(y_min,75)#y_max)
    
    ylabel <- "Cum. Percent of Dose"
    
    plot(1,1, type = "n", xlab = xlabel, xlim = c(0,xmax),
         ylab = ylabel, ylim = Eylim, log = "y")
    lines(out$time.hr, urine.percent, lty = cor.templ.lty, col = cor.templ.col, lwd = 3)
    points(excretion.data[,3], excretion.data[,4], pch = 19, col = paper.col)
    lines(excretion.data[,1], excretion.data[,2], lty = paper.lty, col = paper.col, lwd = 2)
    title("Urine", line = -1.25)
    
    lines(out$time.hr, feces.percent, lty = cor.templ.lty, col = cor.templ.col, lwd = 3)
    points(excretion.data[,7], excretion.data[,8], pch = 19, col = paper.col)
    lines(excretion.data[,5], excretion.data[,6], lty = paper.lty, col = paper.col, lwd = 2)
...
plot.3M.Loccisano <- function(out, sex = "male", img.name = NULL){
  ...
  if (sex == "male"){
    plasma.data <- read.csv(file = paste0(data.loc, "Fig4_3M_OralPlasma.csv"), header = TRUE, sep = ",")
    liver.data <- read.csv(file = paste0(data.loc, "Fig4_3M_OralLiver.csv"), header = TRUE, sep = ",")
  } else if (sex == "female"){
    plasma.data <- read.csv(file = paste0(data.loc, "Fig6_3M_OralPlasma.csv"), header = TRUE, sep = ",")
    liver.data <- read.csv(file = paste0(data.loc, "Fig6_3M_OralLiver.csv"), header = TRUE, sep = ",")
  }
  ...
  y_min <- min(out$C_bl[out$C_bl > 0], plasma.data[,2], na.rm = TRUE)
  y_max <- max(out$C_bl, plasma.data[,2], na.rm = TRUE)
  Pylim <- c(y_min,y_max)
  ...
  lines(plasma.data[,1], plasma.data[,2], lty = paper.lty, lwd = 2, col = paper.col)
  points(plasma.data[,3],plasma.data[,4], pch = 19, col = paper.col)
  points(plasma.data[,5],plasma.data[,6], pch = 19, col = paper.col)
  points(plasma.data[,7],plasma.data[,8], pch = 19, col = paper.col)
  title("Plasma", line = -1.25)
  ...
  points(liver.data[,3],liver.data[,4], pch = 19, col = paper.col)
  lines(liver.data[,1], liver.data[,2], lty = paper.lty, col = paper.col, lwd = 2)
  title("Liver", line = -1.25)
